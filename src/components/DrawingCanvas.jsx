...
export const DrawingCanvas = ({ onClose, onRecognize }) => {
  ...
  useEffect(() => {
    const loadML5 = async () => {
      try {
        // Trực tiếp dùng CDN, không dùng import("ml5") để Vite khỏi báo lỗi
        if (window.ml5) {
        ...
        if (ml5Ref.current) {
          ...
          // Dùng DoodleNet - AI Đỉnh cao chuyên nhận diện nét vẽ tay
          ml5Instance
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex items-center justify-between shrink-0 px-4 py-3 border-b md:px-6 md:py-4 bg-linear-to-r from-ivory to-white border-gray-200/50">
        ...
        <div className="relative flex-1 md:h-[450px] md:flex-none shrink-0 min-h-0 bg-linear-to-br from-gray-50 to-gray-100">
        ...
        <div className="shrink-0 p-3 border-t md:p-4 bg-linear-to-b from-white to-gray-50/50 border-gray-200/50">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-1.5 md:gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 md:gap-1.5 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium text-white transition-all bg-linear-to-r from-red-600 to-red-700 rounded-lg hover:from-red-700 hover:to-red-800 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
              >
                {isRecognizing ? (
                  <>
        ...
        <AnimatePresence>
          {(predictions.length > 0 || error) && (
            <motion.div
              ...
              className="overflow-y-auto border-t border-gray-200/50 bg-linear-to-b from-white to-gray-50/30 max-h-48"
            >
              <div className="p-4">
                {error && (
                  <motion.div
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-16 h-2 overflow-hidden bg-gray-200 rounded-full">
                              <div
                                className="h-full transition-all rounded-full bg-linear-to-r from-red-500 to-red-600"
